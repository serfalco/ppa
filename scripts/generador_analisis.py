...
Fusión de Institucional + Expectativas → /analisis/

Genera:
  - site/analisis/index.html  (la sección principal)
  - site/institucional/index.html  (redirect 301 → /analisis/)
  - site/expectativas/index.html   (redirect 301 → /analisis/)
...
DIR_ANALISIS  = os.path.join(DIR_SITE, "analisis")
...
<main class="an-main">
  <div class="contenedor">
    ...
    <div class="an-header">
      <h1 class="an-titulo-seccion">Análisis</h1>
...
<script src="/assets/ppa.js"></script>
    ...
    _generar_redirect(DIR_INST, "/analisis/", "Institucional")
    _generar_redirect(DIR_EXPECT, "/analisis/", "Expectativas de mercado")
