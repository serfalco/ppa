...
FUENTES = [
    ...
    {
        "id": "investing_intl2",
        "nombre": "Investing Mundo",
        "categoria": "Internacional",
        "tier": 1,
        "rss": "https://es.investing.com/rss/news_95.rss",
        "web": "https://es.investing.com/rss/news_95.rss",
        "descripcion": "Noticias económicas globales de Investing.",
        "activa": True,
    },
    # ============ LABORAL ============
    {
