...
FUENTES = [
    ...
    # Energía / Minería
    {"id":"mejorenergia",   "nombre":"Mejor Energía",          "web":"https://www.mejorenergia.com.ar/feed/",                            "categoria":"Energía",     "tier":2, "activa":False},
    {"id":"dataenergia",    "nombre":"Data Energía",           "web":"https://dataenergia.ar/feed/",                                     "categoria":"Energía",     "tier":2, "activa":True},
    {"id":"rionegro_en",    "nombre":"Río Negro Energía",      "web":"https://www.rionegro.com.ar/energia/feed/",                        "categoria":"Energía",     "tier":2, "activa":False},
    ...
    {"id":"miningpress",    "nombre":"Mining Press",           "web":"https://miningpress.com/feed/",                                    "categoria":"Minería",     "tier":2, "activa":False},
    {"id":"panoramaminero", "nombre":"Panorama Minero",        "web":"https://panoramaminero.com.ar/es/feed/",                           "categoria":"Minería",     "tier":2, "activa":False},
    ...
    # Agro
    {"id":"bcr",            "nombre":"Bolsa de Cereales Rosario","web":"https://www.bcr.com.ar/feed.xml",                               "categoria":"Agro",        "tier":2, "activa":False},
    {"id":"magyp",          "nombre":"Ministerio de Agricultura","web":"https://www.argentina.gob.ar/noticias/rss-agricultura.xml",      "categoria":"Agro",        "tier":2, "activa":False},
    ...
    {"id":"bichosdecampo",  "nombre":"Bichos de Campo",        "web":"https://bichosdecampo.com/feed/",                                  "categoria":"Agro",        "tier":2, "activa":True},
    {"id":"agrositio",      "nombre":"Agrositio",              "web":"https://www.agrositio.com.ar/feed/",                               "categoria":"Agro",        "tier":2, "activa":False},
    ...
    {"id":"autoblog",       "nombre":"Autoblog Argentina",     "web":"https://autoblog.com.ar/feed/",                                    "categoria":"Automotor",   "tier":2, "activa":False},
    {"id":"autoblog_nov",   "nombre":"Autoblog Novedades",     "web":"https://autoblog.com.ar/category/novedades/feed/",                 "categoria":"Automotor",   "tier":2, "activa":False},
    {"id":"autoblog_lan",   "nombre":"Autoblog Lanzamientos",  "web":"https://autoblog.com.ar/category/lanzamientos/feed/",              "categoria":"Automotor",   "tier":2, "activa":False},
    {"id":"diariodeautos",  "nombre":"Diario de Autos",        "web":"https://www.diariodeautos.com.ar/index.php?format=feed&type=rss",  "categoria":"Automotor",   "tier":2, "activa":False},
    {"id":"ambito_acara",   "nombre":"Ámbito ACARA",           "web":"https://www.ambito.com/rss/tags/acara.xml",                        "categoria":"Automotor",   "tier":2, "activa":False},
    ...
    {"id":"hablemoslog",    "nombre":"Hablemos de Logística",  "web":"https://hablemosdelogistica.com/feed/",                            "categoria":"Logística",   "tier":2, "activa":False},
    {"id":"enfasis_log",    "nombre":"Énfasis Logística",      "web":"https://thelogisticsworld.com/historico-enfasis-logistica-sudamerica/feed/", "categoria":"Logística", "tier":2, "activa":False},
    {"id":"infobae_movant", "nombre":"Infobae Movant LogComex","web":"https://www.infobae.com/feeds/rss/?sections=movant",               "categoria":"Logística",   "tier":2, "activa":False},

    # Laboral
    {"id":"eldial",         "nombre":"El Dial Laboral",        "web":"https://www.eldial.com/nuevo/rss-laboral.asp",                     "categoria":"Laboral",     "tier":2, "activa":False},
    ...
    # Internacional
    {"id":"cincodias",      "nombre":"Cinco Días",             "web":"https://cincodias.elpais.com/seccion/rss/economia/",               "categoria":"Internacional","tier":2, "activa":False},
    ...
    {"id":"fmi",            "nombre":"FMI",                    "web":"https://www.imf.org/en/News/rss?language=eng",                     "categoria":"Internacional","tier":2, "activa":False},
    {"id":"bancomundial",   "nombre":"Banco Mundial",          "web":"https://blogs.worldbank.org/es/rss.xml",                           "categoria":"Internacional","tier":2, "activa":False},
    {"id":"bid",            "nombre":"BID",                    "web":"https://blogs.iadb.org/rss.xml",                                  "categoria":"Internacional","tier":2, "activa":False},
    {"id":"cepal",          "nombre":"CEPAL",                  "web":"https://www.cepal.org/es/rss.xml",                                 "categoria":"Internacional","tier":2, "activa":False},

    # Fulbito
    {"id":"ole",            "nombre":"Olé",                    "web":"https://www.ole.com.ar/rss/home.xml",                              "categoria":"Fulbito",     "tier":2, "activa":False},
    {"id":"tycsports",      "nombre":"TyC Sports",             "web":"https://www.tycsports.com/rss.xml",                                "categoria":"Fulbito",     "tier":2, "activa":False},
    {"id":"infobae_dep",    "nombre":"Infobae Deportes",       "web":"https://www.infobae.com/feeds/rss/deportes/",                      "categoria":"Fulbito",     "tier":2, "activa":False},
    ...
    {"id":"iprof_mgmt",   "nombre":"iProfesional Management",  "web":"https://www.iprofesional.com/rss/management",      "categoria":"Laboral",     "tier":1, "activa":True},
    {"id":"iprof_autos",  "nombre":"iProfesional Autos",       "web":"https://www.iprofesional.com/rss/autos",           "categoria":"Automotor",   "tier":1, "activa":True},
    {"id":"iproup_fin",   "nombre":"iProUP Fintech",           "web":"https://www.iproup.com/rss/finanzas",          "categoria":"Finanzas",    "tier":1, "activa":True},
